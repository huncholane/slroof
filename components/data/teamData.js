const teamData = [
  {
    ...
    sidenote: {
      ...
      content:
        "Shaun will be there to ensure your project is completed to the highest standards.",
      quotes: [
        "Every roof we build is a testament to our commitment to quality and craftsmanship.",
        "Your satisfaction is our top priority; we don't just build roofs, we build trust.",
        "With 30 years in the industry, we know what it takes to deliver excellence on every project.",
        "A strong roof means peace of mind, and that's what we aim to provide for every client.",
        "From minor repairs to major installations, we bring the same level of dedication and expertise to every job.",
      ],
    },
  },
  {
